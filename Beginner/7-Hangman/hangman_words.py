word_list = [
'abandon', 'ability', 'absence', 'academy', 'account', 'achieve', 'acoustic', 'action', 'adapt', 'addict', 'adequate', 'adjust', 'admiral', 'adventure', 'aerial', 'afraid', 'afternoon', 'against', 'agency', 'agree','airline', 'airport', 'alarm', 'album', 'alcohol', 'alert', 'alien', 'alley', 'allow', 'alone', 'alphabet', 'already', 'alter', 'alternative', 'although', 'amazing', 'ambition', 'amount', 'amusement', 'analyze','ancient', 'angel', 'anger', 'angle', 'animal', 'announce', 'annual', 'anonymous', 'answer', 'anxiety',
    'apartment', 'apology', 'apparent', 'appeal', 'apple', 'approve', 'aquarium', 'arcade', 'architect', 'area',
    'argue', 'arise', 'army', 'around', 'arrange', 'arrest', 'arrival', 'arrow', 'article', 'artist',
    'ashamed', 'aside', 'ask', 'aspect', 'assemble', 'assert', 'assign', 'assist', 'assume', 'athlete',
    'atmosphere', 'atom', 'attach', 'attack', 'attend', 'attract', 'auction', 'audience', 'audio', 'author',
    'autumn', 'average', 'avocado', 'avoid', 'awake', 'awesome', 'awful', 'awkward', 'axis', 'baby',
    'bachelor', 'bacon', 'badge', 'bag', 'balance', 'balcony', 'ball', 'bamboo', 'banana', 'banner',
    'bar', 'barely', 'bargain', 'barrel', 'base', 'basket', 'bathroom', 'battery', 'battle', 'beach',
    'bean', 'bear', 'beauty', 'because', 'become', 'beef', 'before', 'begin', 'behave', 'behind',
    ...
    'brain', 'brave', 'bread', 'breeze', 'brick', 'bridge', 'brief', 'bright', 'bring', 'brisk',
    ...
    'celebrate', 'cell', 'cement', 'census', 'century', 'cereal', 'certain', 'chair', 'chalk', 'champion',
    ...
    'wealth', 'weapon', 'wear', 'weasel', 'weather', 'web', 'wedding', 'week', 'wheat', 'wheel',
